...
interface UseInvoiceTransactionsReturn {
...
/**
 * Hook for fetching transactions for a specific recurring invoice (bill) with infinite scroll/pagination
 * @param billId - The ID of the bill
 * @param pageSize - Number of transactions per page
 */
export const useInvoiceTransactions = (
    billId: number,
    pageSize: number = 20,
): UseInvoiceTransactionsReturn => {
