...
interface UsePaybookTransactionsReturn {
...
/**
 * Hook for fetching transactions for a specific loan (paybook) with infinite scroll/pagination
 * @param loanId - The ID of the loan
 * @param pageSize - Number of transactions per page
 */
export const usePaybookTransactions = (
    loanId: number,
    pageSize: number = 20,
): UsePaybookTransactionsReturn => {
